            ...
            if (choiceCategory == 0) {
                ...
                if (choiceOrder == 1) {
                    ...
                    for (Discount d : Discount.values()) {
                        System.out.printf("%d. %-6s : %d%%%n", idx++, d.getLabel(), (int)(d.getDiscountRate() * 100));
                    }

                    System.out.print("할인 정보를 입력해주세요: ");
                    int choiceDiscount = scanner.nextInt();

                    Discount discountType = Discount.STUDENT;
                    switch (choiceDiscount) {
                        case 1 : discountType = Discount.NATIONAL_MERIT; break;
                        case 2 : discountType = Discount.MILITARY; break;
                        case 3 : discountType = Discount.STUDENT; break;
                        default: discountType = Discount.GENERAL; break;
                    }

                    cart.orders(discountType);
                }
                continue;
            }
